...
> {
    ...
    render() {
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-[var(--surface-dark)] flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
                        ...
                        <div className="flex gap-3 justify-center">
                            <button
                                ...
                                className="flex items-center gap-2 bg-[var(--primary-500)] text-white px-4 py-2 rounded hover:bg-[var(--primary-700)] transition-colors"
                            >
