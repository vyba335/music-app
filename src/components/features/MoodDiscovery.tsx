...
const MoodDiscovery: React.FC = () => {
    ...
    const moods = [
        ...
        },
        {
            ...
            description: "High energy and pumped up",
        },
        {
            name: "Relaxed",
            icon: TreePalm,
        ...
        <div className="card glass p-6">
            <div className="text-center mb-6">
                ...
                <p className="text-gray-200">
                    How are you feeling today? Let AI find the perfect music for
                    your mood.
                </p>
            </div>
                        ...
                        <button
                            ...
                            className={`p-4 rounded-lg border-2 transition-all hover:shadow-md disabled:opacity-50 ${
                                selectedMood === mood.name
                                    ...
                                    : "border-[var(--primary-500)] hover:border-gray-300"
                            } cursor-pointer`}
                        >
                            <div className="flex flex-col items-center space-y-2">
                                <div
                                    className={`p-2 rounded-full ${mood.color}`}
                                >
                                    <IconComponent className="w-6 h-6" />
                                </div>
                                <div className="text-center">
                                    <h3
                                        className={`font-medium text-shad ${
                                            selectedMood === mood.name
                                                ? "text-gray-800"
            ...
            {recommendations.length > 0 && (
                <div className="space-y-4">
                    ...
                    {recommendations.map((rec, index) => (
                        <div
                            key={index}
                            className="border border-[var(--primary-500)] rounded-lg p-4 hover:shadow-md transition-shadow"
                        >
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    <h4
                                        className="font-semibold text-lg text-white hover:text-[var(--primary-500)] cursor-pointer transition-colors"
                                        onClick={() =>
                                ...
                                <Music2 className="w-5 h-5 text-[var(--primary-500)] ml-4 flex-shrink-0" />
                            </div>
                        </div>
                    ))}
                </div>
