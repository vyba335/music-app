...
const ArtistInsights: React.FC<ArtistInsightsProps> = ({ artistName, className = ""}) => {
        ...
        return (
            <div className={`bg-[#272932] rounded-lg shadow-lg p-6 ${className}`}>
                <div className="flex items-center justify-center py-8">
                    ...
                    <span className="ml-2 text-gray-300">Generating AI insights...</span>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className={`bg-[#272932] rounded-lg shadow-lg p-6 ${className}`}>
                <div className="text-red-600 text-sm p-3 bg-red-50 rounded-lg border border-red-200">
                    {error}
                    <button onClick={generateInsights} className="ml-2 text-red-700 underline hover:no-underline">
                        Try again
                    </button>
                </div>
            </div>
    ...
    return (
        <div className={`bg-[#272932] rounded-lg shadow-lg p-6 ${className}`}>
                ...
                <div className="space-y-6">
                    {/* Musical DNA */}
                    <div className="bg-[#272932] rounded-lg p-4 border border-[#95c623]">
                        <div className="flex items-center gap-2 mb-2">
                            <Music className="w-4 h-4 text-purple-600" />
                            <h3 className="font-semibold text-gray-200">Musical DNA</h3>
                        </div>
                        <p className="text-purple-200 text-sm leading-relaxed">{insights.musicalDNA}</p>
                    </div>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="font-semibold text-gray-200">Career Highlights</h3>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="font-semibold text-gray-200">Musical Influences</h3>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="font-semibold text-gray-200">Fun Facts</h3>
                        </div>
                        <ul className="space-y-2">
