...
const SongAnalyzer: React.FC<SongAnalyzerProps> = ({
    ...
    const analyzeSong = async () => {
        ...
        try {
            ...
            setError(
                err instanceof Error ? err.message : "Failed to analyze song"
            );
            console.error(err);
        } finally {
            setLoading(false);
    ...
    return (
        <div
            className={`bg-[var(--surface-dark)] rounded-lg shadow-lg p-4 ${className}`}
        >
            ...
            {analysis && (
                <div className="space-y-4">
                    ...
                    {/* Musical style */}
                    <div>
                        <h4 className="font-medium tex-gray-100 mb-2 text-sm">
                            Musical Style:
                        </h4>
                        <p className="text-gray-300 text-sm">
                            {analysis.musicalStyle}
                        </p>
                    </div>

                    {/* Song Story */}
                    <div>
                        <h4 className="font-medium text-gray-100 mb-1 text-sm">
                            What It's About:
                        </h4>
                        <p className="text-gray-300 text-sm">
                            {analysis.songStory}
