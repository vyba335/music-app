        ...
        try {
            ...
            const mockData: DashboardData = {
                ...
                recommendedArtists: [
                    {
                        name: "Linkin Park",
                        reason: "Perfect for your energetic mood today",
                        confidence: 92,
                    },
                    {
                        name: "Green Day",
                        reason: "Based on your recent rock preferences",
                        confidence: 87,
                    },
                    {
                        name: "Radical Something",
                        reason: "Indie vibes matching your taste",
                        confidence: 84,
                    },
                ],
                trendingGenres: [
                ...
                <div className="animate-pulse space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {[1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className="h-32 bg-gray-700 rounded"
                            ></div>
                        ))}
                    </div>
                </div>
    ...
    return (
        <div className="bg-[var(--surface-dark)] rounded-lg shadow-lg p-6">
            <div className="flex items-center gap-2 mb-6">
                <TrendingUp className="w-6 h-6 text-[var(--primary-500)]" />
                <h2 className="text-2xl font-bold text-white">
                    Your Music Intelligence Dashboard
                </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gradient-tobr from-orange-500 to-red-600 rounded-lg p-6 text-white">
                    ...
                    <p className="text-2xl font-bold mb-2">
                        {dashboardData.trendingGenres[0]}
                    </p>
                    <p className="text-white/80 text-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div className="bg-gray-800 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                        {dashboardData.recommendedArtists.map(
                            (artist, index) => (
                                <div
                                    key={index}
                                ...
                                >
                                    <div>
                                        <h4 className="font-medium text-white hover:text-[var(--primary-500)] transition-colors">
                                            {artist.name}
                                        </h4>
                                    ...
                                    <span className="text-xs bg-[var(--primary-500)] text-white px-2 py-1 rounded">
                                        {artist.confidence}%
                                    </span>
                                </div>
                            )
            ...
            <div className="mt-6 bg-gray-800 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {dashboardData.personalizedInsights.map(
                        (insight, index) => (
                            <div
                                key={index}
